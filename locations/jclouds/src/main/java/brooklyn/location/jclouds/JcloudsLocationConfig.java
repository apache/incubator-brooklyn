...
public interface JcloudsLocationConfig extends CloudLocationConfig {
    ...
    public static final ConfigKey<String> LOGIN_USER = new StringConfigKey("loginUser", 
...
//            "Passphrase for the custom private key for the user who logs in initially", null);
    ...
    public static final ConfigKey<String> HARDWARE_ID = new StringConfigKey("hardwareId", 
            "A system-specific identifier for the hardware profile or machine type to be used when creating a VM", null);
    
    public static final ConfigKey<String> IMAGE_ID = new StringConfigKey("imageId", 
            "A system-specific identifier for the VM image to be used when creating a VM", null);
    public static final ConfigKey<String> IMAGE_NAME_REGEX = new StringConfigKey("imageNameRegex", 
            "A regular expression to be compared against the 'name' when selecting the VM image to be used when creating a VM", null);
    public static final ConfigKey<String> IMAGE_DESCRIPTION_REGEX = new StringConfigKey("imageDescriptionRegex", 
    ...
    public static final ConfigKey<String> TEMPLATE_SPEC = new StringConfigKey("templateSpec", 
    ...
    public static final ConfigKey<String> DEFAULT_IMAGE_ID = new StringConfigKey("defaultImageId", 
    ...
    public static final ConfigKey<String> USER_DATA_UUENCODED = new StringConfigKey("userData", 
