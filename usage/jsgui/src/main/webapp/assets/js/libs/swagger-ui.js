...
//                log("li_content_dom_id " + li_content_dom_id);
	...
	expandEndpointListForResource: function(resource) {
		$('[id^=resource_' + Docs.escapeResourceName(resource) + ']').addClass('active');
	...
	collapseEndpointListForResource: function(resource) {
		$('[id^=resource_' + Docs.escapeResourceName(resource) + ']').removeClass('active');
...
templates['resource'] = template(function (Handlebars,depth0,helpers,partials,data) {
  ...
  buffer += escapeExpression(stack1) + "');\">+/-</a>\n        </li>\n        <li>\n            <a swag='#' onclick=\"Docs.collapseOperationsForResource('";
  foundHelper = helpers.name;
  stack1 = foundHelper || depth0.name;
  if(typeof stack1 === functionType) { stack1 = stack1.call(depth0, { hash: {} }); }
  else if(stack1=== undef) { stack1 = helperMissing.call(depth0, "name", { hash: {} }); }
  buffer += escapeExpression(stack1) + "'); return false;\">\n                +\n            </a>\n        </li>\n        <li>\n            <a swag='#' onclick=\"Docs.expandOperationsForResource('";
  foundHelper = helpers.name;
  stack1 = foundHelper || depth0.name;
  if(typeof stack1 === functionType) { stack1 = stack1.call(depth0, { hash: {} }); }
  else if(stack1=== undef) { stack1 = helperMissing.call(depth0, "name", { hash: {} }); }
...
(function() {
  ...
  OperationView = (function(_super) {
    ...
    OperationView.prototype.toggleOperationContent = function() {
      var elem;
      elem = $('#' + Docs.escapeResourceName(this.model.resourceName) + "_" + this.model.nickname + "_" + this.model.httpMethod + "_content");
      if (elem.is(':visible')) {
