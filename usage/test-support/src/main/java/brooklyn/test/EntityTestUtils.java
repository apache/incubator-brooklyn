...
public class EntityTestUtils {
    ...
    public static void assertPredicateEventuallyTrue(final Entity entity, final Predicate<Entity> predicate) {
        assertPredicateEventuallyTrue(Maps.newLinkedHashMap(), entity, predicate);
    }

    public static void assertPredicateEventuallyTrue(Map<?,?> flags, final Entity entity, final Predicate<Entity> predicate) {
        TestUtils.executeUntilSucceeds(flags, new Runnable() {
                public void run() {
