...
public class MontereyBrooklynPolicyTest extends CloudsoftThreadMonitoringTestFixture {

    // TODO Some of this test logic will be useful for testing monterey.
    // Review when we begin to write/test policies for monterey, and either
    // delete or cleanup/move then.
    
//    @SuppressWarnings("unused")
//    private static final Logger LOG = Loggers.getLoggerForClass();
//    static {
//        Logger.getLogger("com.cloudsoftcorp.monterey.brooklyn").setLevel(Level.FINEST);
//    }
//    
