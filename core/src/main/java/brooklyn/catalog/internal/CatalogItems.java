...
class CatalogItems {
    ...
    public static CatalogTemplateItemDto newTemplateFromJava(String id, String javaType, String name, String description, CatalogLibrariesDto libraries) {
        return set(new CatalogTemplateItemDto(), id, javaType, BasicBrooklynCatalog.NO_VERSION, javaType, name, description, libraries);
    }

    public static CatalogEntityItemDto newEntityFromPlan(String registeredTypeName, String version, CatalogLibrariesDto libraries, DeploymentPlan plan, String underlyingPlanYaml) {
        CatalogEntityItemDto target = set(new CatalogEntityItemDto(), null, registeredTypeName, version, null, plan.getName(), plan.getDescription(), libraries);
    ...
    public static CatalogEntityItemDto newEntityFromJava(String id, String javaType, String name, String description, CatalogLibrariesDto libraries) {
        return set(new CatalogEntityItemDto(), id, javaType, BasicBrooklynCatalog.NO_VERSION, javaType, name, description, libraries);
    }
    ...
    public static CatalogPolicyItemDto newPolicyFromJava(String id, String javaType, String name, String description, CatalogLibrariesDto libraries) {
        return set(new CatalogPolicyItemDto(), id, javaType, BasicBrooklynCatalog.NO_VERSION, javaType, name, description, libraries);
    }
 
    @SuppressWarnings({ "rawtypes", "unchecked" })
    private static <T extends CatalogItemDtoAbstract> T set(T target, String id, String registeredType, String version, String javaType, String name,
