...
//        ConfigBag bag = new ConfigBag().putAll(flags);
        ...
        if (flags.get("displayName") != null) {
            ...
            displayName.set(getClass().getSimpleName()+":"+id.substring(0, Math.min(id.length(), 4)));
    ...
    public void setManagementContext(ManagementContextInternal managementContext) {
        ...
        if (displayNameAutoGenerated) displayName.set(getEntityType().getSimpleName()+":"+id.substring(0, Math.min(id.length(), 4)));
