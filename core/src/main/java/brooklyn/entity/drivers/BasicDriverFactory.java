...
public class BasicDriverFactory implements EntityDriverFactory {
    ...
    @Override
   public <D extends EntityDriver> D build(DriverAwareEntity<D> entity, Location location){
    ...
    private Constructor getConstructor(Class<? extends EntityDriver> driverClass) {
