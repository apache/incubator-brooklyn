package brooklyn.management.internal.catalog;
...
public class BasicBrooklynCatalog implements BrooklynCatalog {
    ...
    private Map<String, Class<? extends AbstractEntity>> registeredEntities = Maps.newConcurrentMap();
    private Map<String, Class<? extends AbstractPolicy>> scannedPolicies = Collections.emptyMap();
    private Map<String, Class<? extends AbstractPolicy>> registeredPolicies = Maps.newConcurrentMap();
    ...
    public void addEntityClass(Class<? extends Entity> clazz) {
        registeredEntities.put(clazz.getName(), (Class<? extends AbstractEntity>) clazz);
    }
    
    @SuppressWarnings("unchecked")
    @Override
    public void addPolicyClass(Class<? extends Policy> clazz) {
        registeredPolicies.put(clazz.getName(), (Class<? extends AbstractPolicy>) clazz);
    }
