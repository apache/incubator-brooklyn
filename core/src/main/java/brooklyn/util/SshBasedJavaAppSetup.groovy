...
public abstract class SshBasedJavaAppSetup extends SshBasedAppSetup {
    ...
    public void config() {
        super.config()
        envVariablesToSet = generateAndCopyPropertyFiles(false, environmentPropertyFiles)
        generateAndCopyPropertyFiles(true, namedPropertyFiles)
    }

    private Map<String,String> generateAndCopyPropertyFiles(boolean named, Map<String,Map<String,String>> propertyFiles) {
        ...
        for (Map.Entry<String,Map<String,String>> entry in propertyFiles) {
            ...
            String file = named ? name : (LanguageUtils.newUid() + ".properties")
            ...
            try {
                ...
                fos.flush()
                String remote = "${runDir}/${file}.properties"
