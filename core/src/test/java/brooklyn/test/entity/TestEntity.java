...
public interface TestEntity extends Entity, Startable, EntityLocal, EntityInternal {
    ...
    public static final MapConfigKey<Object> CONF_MAP_THING_OBJECT = new MapConfigKey<Object>(Object.class, "test.confMapThing", "Configuration key that's a map thing with objects");
