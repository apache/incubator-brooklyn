...
public class SshTasks {
    ...
    public static SshExecTaskFactory<Integer> newSshExecTaskFactory(SshMachineLocation machine, String ...commands) {
    ...
    public static SshExecTaskFactory<Boolean> dontRequireTtyForSudo(SshMachineLocation machine, final boolean requireSuccess) {
        return newSshExecTaskFactory(machine, 
            ...
            .returning(new Function<SshExecTaskWrapper<?>,Boolean>() { public Boolean apply(SshExecTaskWrapper<?> task) {
    ...
    /** Function for use in {@link SshExecTaskFactory#returning(Function)} which logs all information, optionally requires zero exit code, 
     * and then returns stdout */
    public static Function<SshExecTaskWrapper<?>, String> returningStdoutLoggingInfo(final Logger logger, final boolean requireZero) {
        return new Function<SshExecTaskWrapper<?>, String>() {
          public String apply(@Nullable SshExecTaskWrapper<?> input) {
