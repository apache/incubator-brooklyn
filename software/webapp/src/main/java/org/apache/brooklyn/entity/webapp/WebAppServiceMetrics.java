...
public interface WebAppServiceMetrics {
    ...
    public static final org.apache.brooklyn.core.event.basic.BasicAttributeSensor<Integer> ERROR_COUNT =
            new org.apache.brooklyn.core.event.basic.BasicAttributeSensor<Integer>(Integer.class, "webapp.reqs.errors", "Request errors");
