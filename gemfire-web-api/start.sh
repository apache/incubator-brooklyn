...
java -cp brooklyn-gemfire-web-api-0.2.0-SNAPSHOT-with-dependencies.jar:$ADDITIONAL_CLASSPATH brooklyn.gemfire.api.Server $PORT $CONFIG_FILE $TARGET/gemfire.log $LICENSE &
